...
mex -g COMPFLAGS='$COMPFLAGS -O2' '-LC:\Windows\System32\' '-IC:\Archivos de programa\AMD\OpenCL-CLHPP-main\include\' -lOpenCL src\cl_get_devices.cpp src\ocl_dev_mgr.cpp
mex -g COMPFLAGS='$COMPFLAGS -O2' '-LC:\Windows\System32\' '-IC:\Archivos de programa\AMD\OpenCL-CLHPP-main\include\' -lOpenCL src\cl_run_kernel.cpp src\ocl_dev_mgr.cpp
mex -g COMPFLAGS='$COMPFLAGS -O2' '-LC:\Windows\System32\' '-IC:\Archivos de programa\AMD\OpenCL-CLHPP-main\include\' -lOpenCL src\cl_dbg_kernel.cpp src\ocl_dev_mgr.cpp
